...
/* 61 */       lines.append("\n");
/*    */     } 
/* 63 */     if (this.contextMark != null && (this.problem == null || this.problemMark == null || this.contextMark
/*    */       
/* 65 */       .getName().equals(this.problemMark.getName()) || this.contextMark
/* 66 */       .getLine() != this.problemMark.getLine() || this.contextMark
/* 67 */       .getColumn() != this.problemMark.getColumn())) {
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\org\yaml\snakeyaml\error\MarkedYAMLException.class
