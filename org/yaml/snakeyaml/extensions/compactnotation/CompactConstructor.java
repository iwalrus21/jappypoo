...
/*  50 */       Map<String, Object> properties = new HashMap<String, Object>(data.getProperties());
...
/*  81 */         throw new YAMLException("Cannot set property='" + key + "' with value='" + data
/*  82 */             .get(key) + "' (" + data.get(key).getClass() + ") in " + bean);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/*     */     try {
/* 203 */       Property property = getPropertyUtils().getProperty(bean.getClass(), 
/* 204 */           getSequencePropertyName(bean.getClass()));
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\org\yaml\snakeyaml\extensions\compactnotation\CompactConstructor.class
