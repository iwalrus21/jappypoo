...
/*  64 */     super(property.getName(), property.getPropertyType(), 
/*  65 */         discoverGenericType(property));
...
/*  73 */     if (!this.writable) {
/*  74 */       throw new YAMLException("No writable property '" + getName() + "' on class: " + object
/*  75 */           .getClass().getName());
/*     */     }
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\org\yaml\snakeyaml\introspector\MethodProperty.class
