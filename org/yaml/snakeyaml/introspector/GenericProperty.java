...
/* 47 */               this.actualClasses[i] = (Class)((ParameterizedType)actualTypeArguments[i])
/* 48 */                 .getRawType();
...
/* 53 */                 this.actualClasses[i] = Array.newInstance((Class)componentType, 0)
/* 54 */                   .getClass();
/*    */               } else {
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\org\yaml\snakeyaml\introspector\GenericProperty.class
