...
/*  99 */       char c = x.next();
/* 100 */       if (value == null || (ja
/* 101 */         .length() == 0 && value.length() == 0 && c != ',')) {
/* 102 */         return null;
/*     */       }
/* 104 */       ja.put(value);
/*     */       
...
/* 153 */         if (string.length() > 0 && (string.indexOf(',') >= 0 || string
/* 154 */           .indexOf('\n') >= 0 || string.indexOf('\r') >= 0 || string
/* 155 */           .indexOf(false) >= 0 || string.charAt(0) == '"')) {
/* 156 */           sb.append('"');
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\org\json\CDL.class
