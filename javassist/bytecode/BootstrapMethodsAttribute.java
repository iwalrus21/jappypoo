...
/* 112 */     BootstrapMethod[] methods = getMethods();
/* 113 */     ConstPool thisCp = getConstPool();
/* 114 */     for (int i = 0; i < methods.length; i++) {
/* 115 */       BootstrapMethod m = methods[i];
/* 116 */       m.methodRef = thisCp.copy(m.methodRef, newCp, classnames);
/* 117 */       for (int k = 0; k < m.arguments.length; k++) {
/* 118 */         m.arguments[k] = thisCp.copy(m.arguments[k], newCp, classnames);
/*     */       }
/*     */     } 
/* 121 */     return new BootstrapMethodsAttribute(newCp, methods);
/*     */   }
/*     */ }


/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\javassist\bytecode\BootstrapMethodsAttribute.class
