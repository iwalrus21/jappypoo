...
/*     */     
/* 235 */     buffer.append("locals = ["); int i;
/* 236 */     for (i = 0; i < this.locals.length; i++) {
/* 237 */       buffer.append((this.locals[i] == null) ? "empty" : this.locals[i].toString());
/* 238 */       if (i < this.locals.length - 1)
/* 239 */         buffer.append(", "); 
/*     */     } 
/* 241 */     buffer.append("] stack = [");
/* 242 */     for (i = 0; i < this.top; i++) {
/* 243 */       buffer.append(this.stack[i]);
/* 244 */       if (i < this.top - 1)
/* 245 */         buffer.append(", "); 
/*     */     } 
/* 247 */     buffer.append("]");
...
/* 287 */     this.retMerged = retMerged;
/*     */   }
/*     */ }


/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\javassist\bytecode\analysis\Frame.class
