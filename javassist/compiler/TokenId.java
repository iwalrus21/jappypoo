...
/* 93 */   public static final String[] opNames = new String[] { "!=", "%=", "&=", "*=", "+=", "-=", "/=", "<=", "==", ">=", "^=", "|=", "++", "--", "<<", "<<=", ">>", ">>=", "||", "&&", ">>>", ">>>=" };
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */   
/* 99 */   public static final int[] assignOps = new int[] { 37, 38, 42, 43, 45, 47, 0, 0, 0, 94, 124, 0, 0, 0, 364, 0, 366, 0, 0, 0, 370 };
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\javassist\compiler\TokenId.class
