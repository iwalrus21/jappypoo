...
/*     */   
/*     */   public AntiEvade(Minecraft minecraft) {
/*  28 */     super(minecraft, "antievade", 0, Category.PAGE_2);
...
/*     */       }
/*     */       
/*  52 */       if (!isWearingLeatherArmor(entity)) {
/*     */         continue;
/*     */       }
/*     */       
...
/*     */   }
/*     */   
/*     */   private boolean isWearingLeatherArmor(EntityPlayer entity) {
...
/*     */     
/* 104 */     if (head != Items.LEATHER_HELMET) {
/* 105 */       return false;
/*     */     }
/*     */     
/* 108 */     if (body != Items.LEATHER_CHESTPLATE) {
/* 109 */       return false;
/*     */     }
/*     */     
/* 112 */     if (legs != Items.LEATHER_LEGGINGS) {
/* 113 */       return false;
/*     */     }
/*     */     
/* 116 */     if (feet != Items.LEATHER_BOOTS) {
/* 117 */       return false;
/*     */     }
/*     */     
/* 120 */     return true;
...
/*     */       
/* 162 */       if (!evading && 
/* 163 */         isWearingLeatherArmor(target) && !isBlocking(target)) {
...
/* Location:              C:\Users\goat\Desktop\jap upd\Japware (1)-upd.jar!\me\onefightonewin\feature\types\AntiEvade.class
